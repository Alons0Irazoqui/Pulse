...
const CreateChargeModal: React.FC<CreateChargeModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-[2rem] w-full max-w-4xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden relative border border-gray-100" onClick={e => e.stopPropagation()}>
                
                {/* Header */}
                <div className="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-white sticky top-0 z-10">
                    <div className="flex items-center gap-4">
                        <div className="size-12 bg-gradient-to-br from-orange-500 to-orange-600 text-white rounded-2xl flex items-center justify-center shadow-lg shadow-orange-500/30">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                                ...
                                {categoryGroup === 'event' ? (
                                    <div className="bg-blue-50/50 p-5 rounded-2xl border border-blue-100 space-y-3">
                                        {availableEvents.length > 0 ? (
                                            <>
                                                <label className="block text-xs font-bold text-blue-800 uppercase tracking-wide">Selecciona el Evento Inscrito</label>
                                                <div className="relative">
                                                    <span className="absolute left-4 top-3.5 text-blue-400 material-symbols-outlined text-[20px]">event</span>
                                                    <select 
                                                        value={selectedEventId}
                                                        onChange={(e) => setSelectedEventId(e.target.value)}
                                                        className="w-full rounded-xl border-blue-200 bg-white pl-11 pr-4 py-3.5 text-sm font-medium text-gray-900 focus:ring-4 focus:ring-blue-100 focus:border-blue-400 outline-none transition-all cursor-pointer"
                                                    >
                                            ...
                                            <div className="flex items-center gap-3 text-amber-700 bg-amber-50 p-3 rounded-xl border border-amber-100">
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <input 
                                                ...
                                                className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-900 focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all outline-none placeholder:text-gray-400"
                                            />
                                        </div>
                                        <div className="space-y-1.5">
                                            ...
                                            <textarea 
                                                ...
                                                className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm font-medium text-gray-900 focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all outline-none placeholder:text-gray-400 resize-none"
                        ...
                        <div className="flex flex-col h-full bg-gray-50 rounded-3xl p-8 border border-gray-200">
                            <div className="space-y-6 flex-1">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <span className="absolute left-4 top-4 text-gray-400 font-black text-lg group-focus-within:text-orange-500 transition-colors">$</span>
                                        <input 
                                            type="number"
                                            min="0"
                                            value={amount}
                                            onChange={(e) => setAmount(e.target.value)}
                                            className="w-full pl-10 pr-4 py-4 rounded-xl border border-gray-200 bg-white text-2xl font-black text-gray-900 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all outline-none placeholder:text-gray-300"
                                            placeholder="0.00"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input 
                                        ...
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-white text-sm font-medium text-gray-900 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 transition-all outline-none"
                                    />
                                </div>
                                ...
                                <div className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm">
                                    <label className="flex items-center justify-between cursor-pointer group">
                                        <div>
                                            <span className="block text-sm font-bold text-gray-900 group-hover:text-orange-600 transition-colors">Permitir Abonos</span>
                            ...
                            <div className="mt-8 pt-6 border-t border-gray-200 flex gap-4">
                                <button 
                                    onClick={handleClose}
                                    className="flex-1 py-3.5 rounded-xl border border-gray-200 bg-white font-bold text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all text-sm"
                                >
                                    Cancelar
                                </button>
                                <button 
                                    onClick={handleSubmit}
                                    className="flex-[2] py-3.5 rounded-xl bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold hover:from-orange-600 hover:to-orange-700 shadow-lg shadow-orange-500/20 transition-all active:scale-95 flex items-center justify-center gap-2 text-sm"
                                >
